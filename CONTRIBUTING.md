Contributing to CIGA Core
============================

The CIGA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CIGA Core project, and is not to be
confused with overall CIGA Network Protocol consensus changes.

Whether a pull request is merged into CIGA Core rests with the project merge
...
Patches that change CIGA consensus rules are considerably more involved than
...
Where a patch set proposes to change the CIGA consensus, it must have been
...
The project leader is the release manager for each CIGA Core release.
